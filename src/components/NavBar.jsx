...
//                   <button
//                     onClick={handleLogout}
//                     className="btn w-full bg-gradient-to-r from-pink-500 to-red-500 text-white hover:from-red-500 hover:to-pink-500"
//                   >
//                     <IoLogOut /> Logout
//                   </button>
//                 </li>
...
const NavBar = () => {
  ...
  return (
    <nav className="bg-white dark:bg-gray-900 shadow sticky top-0 z-50">
      ...
      {/* Mobile Menu */}
      {mobileOpen && (
        <div className="lg:hidden px-4 pb-4 bg-base-100 shadow-lg rounded-b-lg transition-all duration-300">
          <ul className="menu menu-compact space-y-2">
            <li><NavLink to="/" className="hover:text-pink-500 flex items-center gap-1 transition-colors"><GoHomeFill /> Home</NavLink></li>
            <li><NavLink to="/all-models" className="hover:text-pink-500 transition-colors">Available Foods</NavLink></li>

            {user ? (
              <>
                <li><NavLink to="/profile" className="hover:text-pink-500 transition-colors"><FaUser /> Profile</NavLink></li>
                <li><NavLink to="/add-food" className="hover:text-pink-500 flex items-center gap-1 transition-colors"><ImBoxAdd /> Add Food</NavLink></li>
                <li><NavLink to="/manage-my-foods" className="hover:text-pink-500 transition-colors">Manage My Foods</NavLink></li>
                <li><NavLink to="/my-food-requests" className="hover:text-pink-500 transition-colors">My Requests</NavLink></li>
                <li className="flex items-center justify-between px-2">
                  <span>Theme</span>
