...
const Footer = () => {
  ...
  <ul className="space-y-2 text-sm sm:text-base">
    <li><Link to="/forums" className="hover:text-gray-200 transition">Food Discussion Forums</Link></li>
    <li><Link to="/groups" className="hover:text-gray-200 transition">Cooking Study Groups</Link></li>
    <li><Link to="/events" className="hover:text-gray-200 transition">Food Events & Workshops</Link></li>
    <li><Link to="/leaderboard" className="hover:text-gray-200 transition">Top Chefs Leaderboard</Link></li>
  </ul>
</div>
